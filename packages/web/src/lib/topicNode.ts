// Ported from Solace Lens's useSolaceConnection.ts (buildTopicTree/propagateValues)
// and its TopicNode/TopicStats shared types - the data model the Sunburst chart
// and its rollup logic are built against.
