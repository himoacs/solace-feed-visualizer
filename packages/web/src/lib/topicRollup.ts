...
import type { SunburstSizingMode } from '../components/sunburst/SunburstChart';

/**
 * Turns the raw topic tree from useSolaceMonitor into a *display* tree for
 ...
 * Ported from Solace Lens's topicRollup.ts.
 */
...
export interface RollupOptions {
  /** 1-5. Nodes at this depth are rendered as leaves - their subtree is already
   *  summed into them by useSolaceMonitor's own propagateValues pass. */
  detailLevel: number;
  /** 5-100. A parent with more children than this keeps its top N-1 (by message
