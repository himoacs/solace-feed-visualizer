...
// Ported from Solace Lens's SunburstChart.tsx, itself built against the
// original explorer.solace.dev (topic-hierarchy-metrics-explorer-v2) - the
// D3 color engine, arc/icicle geometry, zoom and label logic below are kept
// verbatim. Deliberately NOT re-skinned in Solace branding: this view keeps
// its own rainbow color wheel and independent light/dark toggle by design.
//
// Adapted from the Lens version only where it depended on things this app
// doesn't have: `theme` is a prop instead of a global ThemeContext, and the
// toast-on-copy feedback (react-hot-toast) is dropped - the clipboard write
// itself still happens on right-click.
